...
@Component
public class JiraToClickhouseTypeAdapter {
    private final FieldManager fieldManager;
    private static final Logger logger = LoggerFactory.getLogger(JiraToClickhouseTypeAdapter.class);

    @Autowired
    public JiraToClickhouseTypeAdapter(@ComponentImport FieldManager fieldManager) {
